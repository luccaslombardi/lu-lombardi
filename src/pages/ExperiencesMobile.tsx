    ...
    return (
        ...
        >
            ...
            <div className=" border-b-[1px] border-zinc-700">
                <button
                    onClick={setTab1}
                    className="py-4 md:py-5 w-1/4 md:w-32 text-sm"
                >
                    Digi+
                </button>
                <button
            ...
            <div
                className={`w-1/4 md:w-32 h-1 mt-[-2px] rounded-lg transition-all 
          ${activeTab === "Tab1"
                        ? "bg-[#04D361]"
                        : activeTab === "Tab2"
                            ? "ml-[25%] md:ml-32 bg-purple-500"
                            : activeTab === "Tab3"
                                ? "ml-[50%] md:ml-2/3 md:ml-64 bg-cyan-400"
                                : activeTab === "Tab4"
                                    ? "ml-[75%] md:ml-3/3 md:ml-96 bg-[#04D361]"
                                    : null
                    }`}
            />
            <div>
