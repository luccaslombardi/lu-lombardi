      ...
      <div className="grid grid-cols-3 gap-14">
        {Object.entries(languages).map(([key, value]) => {
          return (
            <div
              key={key}
              className={`flex items-center group py-8 px-10  justify-self-center bg-violet-400 bg-opacity-10 justify-center text-5xl rounded-lg hover:px-14 hover:rounded-2xl ${value.color} transition-all duration-500 drop-shadow-2xl hover:z-10`}
            >
              {value.image}
