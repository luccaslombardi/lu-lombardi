...
export function Study() {
    return(
        <div className="flex flex-col justify-center items-center pb-16">
            ...
            <h1 className="text-center text-5xl uppercase font-bold pb-20">quem me ajudou</h1>

        
        <div className="grid grid-cols-2 gap-16 w-3/5 max-w-6xl items-center ">
            {Object.entries(courses).map(([key, value])=> {
                return(
                    <div key={key} className="flex items-center p-10 h-[18rem] align-middle border-zinc-700 border-[1px] rounded-lg bg-violet-800 bg-opacity-5">
